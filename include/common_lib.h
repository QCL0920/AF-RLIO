...
POINT_CLOUD_REGISTER_POINT_STRUCT (RadarType,
...
struct MeasureGroup // Lidar data and imu dates for the curent process
{
    MeasureGroup()
    {
        ...
        this->radar_map.reset(new PointCloudXYZI());
        this->radar.reset(new pcl::PointCloud<RadarType>());
        this->odom.reset(new nav_msgs::Odometry());
    };
    double lidar_beg_time;
    double lidar_end_time;
    double radar_beg_time;
    double odom_beg_time;
    double gps_beg_time;
    bool islidar;
    PointCloudXYZI::Ptr lidar;
    PointCloudXYZI::Ptr radar_map;
    deque<sensor_msgs::Imu::ConstPtr> imu;
    deque<sensor_msgs::Imu::ConstPtr> imu_radar;
    deque<sensor_msgs::Imu::ConstPtr> imu_gps;
    pcl::PointCloud<RadarType>::Ptr radar;
